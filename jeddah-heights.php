...
<body>
  ...
  <?php if ($_SESSION['layout'] == 0) : ?>
    ...
    <section class="banner lily-banner hight-banner" id="banner">
      <div class="container">
    ...
    <section class="lily-about">
      ...
      <img src="img/Vector40.png" class="vector-img-40" alt="">
        <div class="row">
          <div class="col-lg-7">
            <div class="content">
              <img src="img/Jeddah-Heights.png" class="yellow-lily" alt="">
              <h3>Abyatona Lily</h3>
          ...
          <div class="col-lg-5">
            <img src="img/belding5.png" class="little-img" alt="">
          </div>
        </div>
      </div>
    </section>
